...
function main(servicesPath, additionalServices) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `digicoincore-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ digicoincore-node add wallet-service');
      console.log('    $ digicoincore-node add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ digicoincore-node remove wallet-service');
      console.log('    $ digicoincore-node remove insight-api');
      console.log();
    });
