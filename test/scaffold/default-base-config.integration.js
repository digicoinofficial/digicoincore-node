...
describe('#defaultBaseConfig', function() {
  it('will return expected configuration', function() {
    ...
    digicoind.spawn.datadir.should.equal(home + '/.digicoin');
    digicoind.spawn.exec.should.equal(path.resolve(__dirname, '../../bin/digicoind'));
  });
  ...
  it('be able to specify a datadir', function() {
    ...
    info.config.servicesConfig.digicoind.spawn.datadir.should.equal('./data2');
  });
});
