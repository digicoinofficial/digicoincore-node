...
describe('Node Functionality', function() {
    ...
    rimraf(datadir + '/regtest', function(err) {
      ...
      node.start(function(err) {
        ...
        var syncedHandler = function() {
          if (node.services.digicoind.height === 150) {
            node.services.digicoind.removeListener('synced', syncedHandler);
            done();
          }
        };

        node.services.digicoind.on('synced', syncedHandler);
  ...
  describe('Bus Functionality', function() {
    it('subscribes and unsubscribes to an event on the bus', function(done) {
      ...
      bus.on('digicoind/hashblock', function(data) {
        bus.unsubscribe('digicoind/hashblock');
        if (blockExpected) {
  ...
  describe('Address Functionality', function() {
    ...
    before(function(done) {
      ...
      var startHeight = node.services.digicoind.height;
      node.services.digicoind.on('tip', function(height) {
    ...
    describe('Mempool Index', function() {
      ...
      it('will update the mempool index after new tx', function(done) {
        ...
        node.services.digicoind.sendTransaction(tx.serialize(), function(err, hash) {
